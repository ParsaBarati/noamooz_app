...
import 'package:noamooz_app/Controllers/Audio/audio_controller.dart';
...
void main() async {
  Globals.audioHandler = await AudioService.init(
    ...
    config: const AudioServiceConfig(
        androidNotificationChannelId: 'com.lexaplus.noamooz_app.channel.audio',
  ...
  await Firebase.initializeApp(
    options: const FirebaseOptions(
      apiKey: 'AIzaSyAkOSdrtfyEtO2pQZ_oiz8NrsTm6breVDY',
      appId: '1:359853604326:android:1668c528bc984ae4b8ea27',
      messagingSenderId: '359853604326',
      projectId: 'noamooz-app',
    ),
    // name: "NoAmooz"
